...
public class TreeInterfaceTest extends TestCase {
    ...
    public void testIntersect() {
        ...
        ln.intersect(101, 0, 0, 100, 1024, 1024, 1);
        ln.intersect(0, 800, 0, 1024, 100, 1024, 1);
        ln.intersect(0, 0, 800, 1024, 1024, 100, 1);
        Drone ao5 = new Drone("MVPwatch5"); // 4th insert
        ao4.setX(203);
        ao4.setY(150);
        ao4.setZ(50);
        ao4.setXWidth(50);
        ...
        ao4.setEngines(3);
        ln = ln.insert(ao5);
        Drone ao6 = new Drone("MVPwatch6"); // 4th insert
        ao4.setX(203);
        ao4.setY(150);
        ao4.setZ(50);
        ao4.setXWidth(50);
